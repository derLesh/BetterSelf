...
import de.lesh.betterself.settings.UserCardSetup;
...
//    public static final SimpleLog LOG = SimpleLog.getLog("BetterSelf");
	...
	public void onMessageReceived(MessageReceivedEvent e) {
		...
		if(msg.getRawContent().startsWith(Main.CONFIG.getPrefix() + "person") && msg.getAuthor().equals(Main.USER)&& !lib.getServerSecure(e)){
